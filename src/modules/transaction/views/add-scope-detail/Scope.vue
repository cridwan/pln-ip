...
import FormAssetWelness from "@/modules/transaction/components/FormAssetWelness.vue";
import FormWithUploadFile from "@/modules/transaction/components/FormWithUploadFile.vue";
import { ColumnsScope } from "@/modules/transaction/constants/ScopeConstant";
import type {
  ...
  <div class="flex gap-8">
    ...
    <div class="flex-1 overflow-auto">
      <div class="max-w-full min-w-full">
        ...
        <Table label-create="Asset" :is_logging="false" :columns="ColumnsScope" :entities="entitiesScope"
          ...
          <template #column_rla="{ entity }">
            <div class="w-full flex justify-center">
              ...
              <FormWithUploadFile v-else ref="rla" :value="entity.rla" :label="entity.asset"
                :loading="is_loading_create" :disabled="dataApproval?.status === 'approve' || !access_token"
          ...
          <template #column_ncr="{ entity }">
            <div class="w-full flex justify-center">
              ...
              <FormWithUploadFile v-else ref="ncr" :value="entity.ncr" :label="entity.asset"
                :loading="is_loading_create" :disabled="dataApproval?.status === 'approve' || !access_token"
              ...
              <td :colspan="ColumnsScope.length + 1">
                <div class="bg-[rgb(207,225,255,0.4)] px-3 py-2 rounded">
                  <TableEquipment :is-additional="true" :id="entity.id" :entity="entity.children"
                    :original_uuid="entity.original_uuid" :status-approval="dataApproval?.status" :open="children_active.find((el) => el.id === entity.id)?.open
                      " @get-data="getData" />
                </div>
              </td>
            </tr>
    ...
    <!-- <FormAdScopeDetail
      ...
      @error="handleError"
    /> -->
    <FormScope ref="formScope" :is-additional="true" v-model="open_form" :dataForm="dataForm"
      :selected-value="selected_item" @success="handleSuccess" @error="handleError" />
  </div>
</template>
