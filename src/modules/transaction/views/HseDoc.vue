...
import type { HseDocInterface, ResponseHseDocInterface } from "../types/HseDocType";
...
<template>
    <Toast ref="toastRef" />
    <Table label-create="QC Plan Document" :columns="ColumnsQcPlan" :entities="entitiesHseDoc"
        ...
        <template #column_preview="{ entity }">
            <div v-if="entity.document" class="w-full flex justify-center">
                <div class="bg-cyan-500 text-center border border-neutral-50 rounded-lg px-2 min-w-[120px] text-base text-neutral-50 cursor-pointer"
