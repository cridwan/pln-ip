...
import type { FormConsMatCloneInterface } from "@/modules/transaction/types/ConsumableMaterialStdType";
...
//--- GET CONSMAT
const params_consumable_material = reactive<IParams & { from_transaction: boolean, additional_scope_uuid: string, from_add_scope: true, original_uuid: string }>({
    search: "",
    filters: [],
    currentPage: 1,
    perPage: 10,
