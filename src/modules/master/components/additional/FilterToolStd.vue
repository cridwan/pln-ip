...
const {
  ...
  queryKey: ["getBidangFilterToolAdditionalMaster"],
...
const {
  ...
  queryKey: ["getSubBidangFilterToolAdditionalMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getScopeFilterToolAdditionalMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getEquipmentFilterToolAdditionalMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getActivityFilterToolAdditionalMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
