...
const {
  ...
  queryKey: ["getBidangFilterManpowerAdditionalMaster"],
...
const {
  ...
  queryKey: ["getSubBidangFilterManpowerAdditionalMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getScopeFilterManpowerAdditionalMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getEquipmentFilterManpowerAdditionalMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getActivityFilterManpowerAdditionalMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
<template>
  ...
  >
    <span class="text-blue-950 font-semibold">Filter Manpower</span>
