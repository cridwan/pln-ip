...
const {
  ...
  queryKey: ["getBidangFilterConsMatAdditionalMaster"],
...
const {
  ...
  queryKey: ["getSubBidangFilterConsMatAdditionalMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getScopeFilterConsMatAdditionalMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getEquipmentFilterConsMatAdditionalMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getActivityFilterConsMatAdditionalMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
<template>
  ...
  >
    <span class="text-blue-950 font-semibold">Filter Consumable Material</span>
