...
const {
  ...
  queryKey: ["getBidangFilterPartAdditionalMaster"],
...
const {
  ...
  queryKey: ["getSubBidangFilterPartAdditionalMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getScopeFilterPartAdditionalMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getEquipmentFilterPartAdditionalMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getActivityFilterPartAdditionalMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
<template>
  ...
  >
    <span class="text-blue-950 font-semibold">Filter Part</span>
