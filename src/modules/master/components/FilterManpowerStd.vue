...
const {
  ...
  queryKey: ["getLocationFilterManpowerStdMaster"],
...
const {
  ...
  queryKey: ["getUnitFilterManpowerStdMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getMachineFilterManpowerStdMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getInspectionFilterManpowerStdMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getBidangFilterManpowerStdMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getSubBidangFilterManpowerStdMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getScopeFilterManpowerStdMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getEquipmentFilterManpowerStdMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getActivityFilterManpowerStdMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const selectLocation = (e: OptionType) => {
  ...
  queryClient.removeQueries({ queryKey: ["getBidangFilterManpowerStdMaster"] });
  queryClient.removeQueries({
    queryKey: ["getSubBidangFilterManpowerStdMaster"],
  });
  queryClient.removeQueries({ queryKey: ["getScopeFilterManpowerStdMaster"] });
  queryClient.removeQueries({
    queryKey: ["getEquipmentFilterManpowerStdMaster"],
  });
  queryClient.removeQueries({
...
<template>
  ...
  >
    <span class="text-blue-950 font-semibold">Filter Manpower Standart</span>
