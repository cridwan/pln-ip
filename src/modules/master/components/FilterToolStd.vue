...
const {
  ...
  queryKey: ["getLocationFilterToolStdMaster"],
...
const {
  ...
  queryKey: ["getUnitFilterToolStdMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getMachineFilterToolStdMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getInspectionFilterToolStdMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getBidangFilterToolStdMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getSubBidangFilterToolStdMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getScopeFilterToolStdMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getEquipmentFilterToolStdMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getActivityFilterToolStdMaster"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const selectLocation = (e: OptionType) => {
  ...
  queryClient.removeQueries({ queryKey: ["getBidangFilterToolStdMaster"] });
  queryClient.removeQueries({
    queryKey: ["getSubBidangFilterToolStdMaster"],
  });
  queryClient.removeQueries({ queryKey: ["getScopeFilterToolStdMaster"] });
  queryClient.removeQueries({
    queryKey: ["getEquipmentFilterToolStdMaster"],
  });
  queryClient.removeQueries({
...
<template>
  ...
  >
    <span class="text-blue-950 font-semibold">Filter Tool Standart</span>
