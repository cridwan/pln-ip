...
const {
  ...
  queryKey: ["getBidangFilterManpowerStd"],
...
const {
  ...
  queryKey: ["getSubBidangFilterManpowerStd"],
...
const {
  ...
  queryKey: ["getScopeFilterManpowerStd"],
...
const {
  ...
  queryKey: ["getEquipmentFIlterManpowerStd"],
...
const {
  ...
  queryKey: ["getActivityFilterManpowerStd"],
