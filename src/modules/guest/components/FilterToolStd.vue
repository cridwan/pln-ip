...
const {
  ...
  queryKey: ["getLocationFilterToolStdMasterGuest"],
...
const {
  ...
  queryKey: ["getUnitFilterToolStdMasterGuest"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getMachineFilterToolStdMasterGuest"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getInspectionFilterToolStdMasterGuest"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getBidangFilterToolStdMasterGuest"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getSubBidangFilterToolStdMasterGuest"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getScopeFilterToolStdMasterGuest"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getEquipmentFilterToolStdMasterGuest"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const {
  ...
  queryKey: ["getActivityFilterToolStdMasterGuest"],
  enabled: false,
  queryFn: async ({ pageParam = 1 }) => {
    try {
...
const selectLocation = (e: OptionType) => {
  ...
  queryClient.removeQueries({ queryKey: ["getScopeFilterToolStdMasterGuest"] });
  queryClient.removeQueries({
    queryKey: ["getEquipmentFilterToolStdMasterGuest"],
  });
  queryClient.removeQueries({
