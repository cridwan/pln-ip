...
} from "@/modules/transaction/types/ActivityType";
...
//--- GET SCOPE
const params_activity = reactive<IParams & { from_transaction: boolean, additional_scope_uuid: string, from_add_scope: true, original_uuid: string }>({
    search: "",
    filter: "",
    filters: [],
    currentPage: 1,
