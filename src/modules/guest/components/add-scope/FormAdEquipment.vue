...
} from "@/modules/transaction/types/EquipmentType";
...
//--- GET SCOPE
const params_Equipment = reactive<IParams & { from_transaction: boolean, additional_scope_uuid: string, from_add_scope: true, original_uuid: string }>({
    search: "",
    filter: "",
    filters: [],
    currentPage: 1,
    ...
    <Modal width="440" height="200" :showButtonClose="false" title="Tambah Equipment" v-model="modelValue">
        <form class="flex flex-col gap-4 max-h-[calc(100vh-200px)] overflow-y-auto mx-[-20px] px-5"
            ...
            <Select v-model="model.equipment_uuid" label="Equipment" options_label="label" options_value="value"
                ...
                :options="options_equipment" @scroll="scrollScope" @search="searchScope" />
