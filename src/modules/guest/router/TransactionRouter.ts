...
export const routeTransaction = [
  {
    ...
    meta: { layout: GuestLayout, requireAuth: false, role: "planner" },
  },
  {
  ...
  },
  {
    ...
    component: () =>
      import("@/modules/guest/views/ConsumableMaterial.vue"),
    meta: { layout: GuestLayout, requireAuth: false, role: "planner" },
  },
  {
  ...
  },
  {
    ...
    component: () =>
      import("@/modules/guest/views/add-scope-detail/Scope.vue"),
    meta: { layout: GuestAddScopeLayout, requireAuth: false, role: "planner" },
  },
  {
  ...
  },
  {
    ...
    component: () =>
      import("@/modules/guest/views/add-scope-detail/Part.vue"),
    meta: { layout: GuestAddScopeLayout, requireAuth: false, role: "planner" },
  },
  {
